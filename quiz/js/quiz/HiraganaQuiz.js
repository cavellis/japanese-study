 ...
 */
var HiraganaQuiz = function()
{

}
HiraganaQuiz.prototype = 
{
	_collection : null,
	_view : null,
	_question:{},
	...
	initialize:function(collection, view)
	{
		...
		$("#quiz-header").html("Japanese - Hiragana");
	...
	readingQuestion:function(randomQuestion)
	{
		...
		$("#question-description").html("<h3>Type the hiragana</h3>");
		//save question so we can check it later
		this._question.answer = randomQuestion.get("hiragana");
	},
	meaningQuestion:function(randomQuestion)
	{
		this.bindWanakana(false);
		var hiragana = randomQuestion.get("hiragana");
		$("#question-name").html(hiragana);
	...
	{
		$("#quiz-instructions-copy").html("Hiragana quiz");
